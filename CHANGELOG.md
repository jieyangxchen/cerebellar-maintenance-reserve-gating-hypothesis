...
- Replaced the free-text interest upload with the completed Elsevier DOCI form generated by the publisher's Declaration Tool, preserving the selected no-competing-interests declaration and the original Word file byte-for-byte.
