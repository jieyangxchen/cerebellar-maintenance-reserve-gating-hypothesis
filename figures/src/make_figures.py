...
def _figure_program(output_dir: Path) -> list[Path]:
    ...
    _box(
        ...
        0.20,
        0.15,
        "5-y natural history\nSCA3 | SCA6 | family controls\n6-mo clinic | annual imaging",
        edge=COLORS["measure"],
        fill=COLORS["measure_fill"],
        fontsize=6.5,
    )
    ...
    ax.text(
        0.04,
        0.59,
        "Independent target-specific evidence gates govern intervention modules",
        fontsize=8.2,
        fontweight="bold",
    )
    ...
    _box(
        ...
        0.27,
        0.20,
        "Conditional SCA3 phase 2\nmutant-ATXN3 lowering\nGate: SCA3 safety + RP2D\n+ CSF target engagement",
        edge=COLORS["known"],
        fill=COLORS["known_fill"],
        fontsize=6.6,
    )
    _box(
        ...
        0.27,
        0.20,
        "SCA6 phase 2b | 72 weeks\nL-arginine vs placebo\nStaged SARA expansion\n10–12 → 5–9 → 3–4",
        edge=COLORS["measure"],
        fill=COLORS["measure_fill"],
        fontsize=6.6,
    )
